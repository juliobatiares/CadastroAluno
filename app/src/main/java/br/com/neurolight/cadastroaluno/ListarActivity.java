...
public class ListarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lstAlunos);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchView sv = (SearchView) menu.findItem(R.id.srcPesquisar).getActionView();
    ...
    public void deletar(MenuItem item) {
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                .setTitle("Atenção")
                .setMessage("Deseja excluir o(a) aluno(a) " + alunoExcluir.getNome() + "?")
    ...
    public void alterar(MenuItem item) {
        ...
        final Aluno alunoAlterar = alunosFiltrados.get(menuInfo.position);
        Intent it = new Intent(this, CadastroAlunoActivity.class);
        it.putExtra("aluno", alunoAlterar);
        startActivity(it);
    }
